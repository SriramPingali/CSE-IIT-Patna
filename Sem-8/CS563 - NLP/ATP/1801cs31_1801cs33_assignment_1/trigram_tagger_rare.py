...
def viterbi_decode(penn_dev_words, taglist, known_words, transition_values, e_values):
    tagged = []
...
def main():
    ...
    viterbi_tagged = viterbi_decode(test_penn_words, taglist, known_words, transition_values, e_values)
