/*
    ...
    Highest Remaining Time First (HRTF) scheduling
*/
#include <bits/stdc++.h>
using namespace std;
...
// function for highest remaining time first scheduling
void hrtf(vector<ptime> &times) {
    int n = times.size();
    ...
    // begin highest remaining time first scheduling
